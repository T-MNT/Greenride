...
const RidePostView = () => {
  ...
  return (
    <div className="flex justify-center bg-Teal h-[84vh]">
        ...
        >
          <Form className="flex flex-col justify-around h-full">
            ...
            <div
              ...
              id="places"
            >
              <label className="text-xl font-bold  text-left">Places : </label>
            ...
            <div className="flex items-center w-full ">
              <label className="w-1/4 text-left text-xl font-bold">
                Bagages :
              </label>
