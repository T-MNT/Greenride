    ...
    <div>
      {trajet != 0 && car != 0 && images != 0 && user != 0 ? (
        <div className="bg-Teal">
          <div className="w-[90%] mx-auto flex-auto py-8">
            <h4 className="text-Whitesmoke  h-auto flex items-center text-left">
              <img
              ...
              />
              <b>
                <NavLink to={`/profils/${user.id}`}>
                  <span className="underline">
                    {user.prenom} {user.nom}
                  </span>
                </NavLink>{' '}
                propose le trajet de {trajet.depart} jusqu'à{' '}
                {trajet.destination}
              </b>
              {/*<button
              ...
              {trajet.places > 0 ? (
                isReservation ? (
                  <button
                    className="bg-[#d63939] hover:bg-[#960000] text-white font-extrabold py-4 px-12 cursor-pointer ml-auto rounded "
                  ...
                  <button
                    className="bg-[#7cc474] hover:bg-[#54b44b] text-white font-extrabold py-2 px-12 cursor-pointer rounded ml-auto"
                    onClick={handleShowModal}
                  >
                    Réserver ce trajet
                  </button>
            ...
            >
              <div className="relative w-auto my-6 mx-auto max-w-3xl">
                <div className="border-solid border-4 border-Teal rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  <div className="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t bg-Moonstone">
                    <h3 className="text-3xl font=semibold">Réservation</h3>
                  </div>
                  <div className="relative p-6 flex-auto">
                    <div className="bg-Moonstone shadow-md rounded px-8 pt-6 pb-8 w-full">
                  ...
                  <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b bg-Moonstone">
                    <button
          ...
          <div
            className={
              'h-[90vh] w-[90%]  bg-Teal flex justify-between mx-auto '
            }
          >
            <div className="w-[700px] h-[700px] rounded-lg bg-Moonstone p-6 shadow-lg shadow-teal-900 block z-10">
              {latDepart != 0 &&
              lngDepart != 0 &&
              latArrivee != 0 &&
              lngArrivee != 0 ? (
            ...
            <div className="w-[700px] h-[700px] rounded-lg bg-Moonstone p-6 shadow-lg flex-col flex shadow-teal-900  text-Whitesmoke">
              <h2 className="mb-6 mt-0.5 text-center w-full">Informations</h2>
              <div className="h-full py-4 flex-col flex justify-between  flex-wrap">
