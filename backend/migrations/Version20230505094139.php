 ...
 */
final class Version20230505094139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avertissements INT NOT NULL, CHANGE date_unban date_unban INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP avertissements, CHANGE date_unban date_unban VARCHAR(255) DEFAULT NULL');
