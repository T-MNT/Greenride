 ...
 */
final class Version20230503084007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alert (id INT AUTO_INCREMENT NOT NULL, user_plaint INT NOT NULL, user_signal INT NOT NULL, trajet INT NOT NULL, date VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_17FD46C1EBFABED6 (user_plaint), UNIQUE INDEX UNIQ_17FD46C1115E8EC8 (user_signal), INDEX IDX_17FD46C12B5BA98C (trajet), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD date_unban INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP date_unban');
